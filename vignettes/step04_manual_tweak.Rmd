...
"Absorbs" all or part of a layer into the surrounding colors, optionally according to a size or location condition. (Output not shown in CRAN vignettes because it does
not run on R's servers.) 

```{r, fig.width=5,eval=F}
library(recolorize)
