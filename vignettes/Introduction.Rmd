...
5. Once you have a color map you're happy with, you can export to a variety of formats. For instance, if I wanted to run Endler's [adjacency and boundary strength analysis](https://www.rdocumentation.org/packages/pavo/versions/2.9.0/topics/adjacent) in the `pavo` package, using human perception:
